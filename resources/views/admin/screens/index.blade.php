        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('admin.screens')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.screens.index')}}" class="text-muted">@lang('admin.screens')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">@lang('admin.screens-table')</h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('admin.screens.create') }}" class="btn btn-primary font-weight-bolder d-flex">
                                ...
                                <table class="table table-bordered table-checkable " id="kt_datatable">
                                    ...
                                    @if(count($screens)>0)
                                        ...
                                        @foreach($screens as $screen)
                                            <tr>
                                                <td>{{$screen->id}}</td>
                                                <td><img src="{{asset_public('storage/uploads/'.$screen->image)}}" style="width: 150px;height: 100px;"></td>
                                                <td>{{$screen->user()->pluck('name')[0]}}</td>
                                                <td nowrap="nowrap">{{ $screen->id }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    @endif
...
<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
    ...
    <label class="checkbox checkbox-single">
        ...
        <label class="checkbox checkbox-single">
            ...
            <a href="${currentLocation}/screens/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
